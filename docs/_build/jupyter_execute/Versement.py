...
# Cette cellule ci-dessus permet de lancer le versement des données toutes récemment restructurées. selon la à la première question de la partie II, la fonction **versementDonnes2** va créer des nouvelles tables et insérer de nouvelles données, ou elle mettra à jour les tables existantes.
# 
...
# 
# 
# - Dans le cas d'une mise à jour de données dans un schéma existant (par exemple l'insertion des données d'une nouvelle année, ou encore l'insertion de données avec une nouvelle échelle ), la fonction va chercher les tables concernées et insérer les données, voire créer de nouvelles tables si besoin.
